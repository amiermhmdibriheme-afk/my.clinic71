...
            <button class="service-btn luxury-card flex flex-col items-center p-6 rounded-xl hover-gold transition-all duration-500" data-service="بوتاکس پریمیوم">
              <span class="text-4xl text-[#FFD700] mb-2">💉</span>
              <span class="luxury-accent persian-text font-medium text-white">بوتاکس پریمیوم</span>
            </button>
            <button class="service-btn luxury-card flex flex-col items-center p-6 rounded-xl hover-gold transition-all duration-500" data-service="فیلر لوکس">
              <span class="text-4xl text-[#FFD700] mb-2">💋</span>
              <span class="luxury-accent persian-text font-medium text-white">فیلر لوکس</span>
            </button>
            <button class="service-btn luxury-card flex flex-col items-center p-6 rounded-xl hover-gold transition-all duration-500" data-service="لیزر پیشرفته">
              <span class="text-4xl text-[#FFD700] mb-2">🔥</span>
              <span class="luxury-accent persian-text font-medium text-white">لیزر پیشرفته</span>
            </button>
            <button class="service-btn luxury-card flex flex-col items-center p-6 rounded-xl hover-gold transition-all duration-500" data-service="مشاوره تخصصی">
              <span class="text-4xl text-[#FFD700] mb-2">👩⚕️</span>
...
            <button class="doctor-btn luxury-card flex flex-col items-center p-6 rounded-xl hover-gold transition-all duration-500" data-doctor="دکتر احمدی">
              <span class="text-4xl text-[#FFD700] mb-2">👨⚕️</span>
              <span class="luxury-accent persian-text font-medium text-white">دکتر احمدی - پوست و زیبایی</span>
            </button>
            <button class="doctor-btn luxury-card flex flex-col items-center p-6 rounded-xl hover-gold transition-all duration-500" data-doctor="دکتر محمدی">
              <span class="text-4xl text-[#FFD700] mb-2">👩⚕️</span>
